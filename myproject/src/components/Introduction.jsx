      ...
      <div className='relative'>
        <div className='pt-20 pb-7 bg-[hsl(44,86%,61%)] w-full flex flex-col md:flex-row px-3 m-auto min-h-[500px] gap-2 items-center  justify-around'>
          ...
          <div className=" flex flex-col  gap-5 justify-between rounded-lg w-full md:w-[80%] p-8">
            ...
            <p className='.nunito-para '> We're here to turn your career ambitions into reality. From helping you choose the right college to offering personalized guidance, we connect your dreams with the best opportunities. Your future starts with us!</p>
