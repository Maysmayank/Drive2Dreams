  ...
  return (
    <div onClick={() => setIsHovered(!isHovered)} onMouseLeave={() => setIsHovered(false)} className='relative bg-white h-[150px] overflow-hidden text-black font-sans w-full p-2 rounded-md'>
      ...
      <div className='flex flex-col gap-3'>
        <p className='text-2xl text-center break-words line-clamp-4'>{title}</p>
      ...
      <EditinfoModal isVisible={isEditModalVisible} onCancel={HandleEditOnCancel} courseid={id} universityid={""} />
    </div>
  )
}
